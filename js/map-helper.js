(function ($) {
    ...
    $(function () {
        ...
        var mapPos = new google.maps.LatLng(19.081685, -98.279637);
        ...
        var markerAPos = new google.maps.LatLng(19.081685, -98.279637);
        var markerA = new CustomMarker({
            position: markerAPos,
            draggable: true,
            map: map
        });
        var markerBPos = new google.maps.LatLng(19.081685, -98.279637);
